# Generated by Django 2.2.7 on 2019-11-26 07:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_SUCCESS', '成功'), ('TRADE_CLOSED', '超时关闭'), ('WAIT_BUYER_PAY', '交易创建'), ('TRADE_FINISHED', '交易结束'), ('TRADE_CANCEL', '取消'), ('TRADE_PAYING', '待支付')], default='TRADE_PAYING', max_length=30, verbose_name='订单状态')),
                ('pay_type', models.CharField(choices=[('ALIPAY', '支付宝'), ('WECHAT', '微信')], max_length=10, verbose_name='支付类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2019, 11, 26, 15, 17, 14, 387026), verbose_name='添加时间')),
