...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2019, 11, 26, 15, 17, 14, 389017), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '用户收藏',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('msg_type', models.IntegerField(choices=[(1, '留言'), (2, '投诉'), (3, '询问'), (4, '售后')], default=1, help_text='留言类型: 1(留言),2(投诉),3(询问),4(售后)', verbose_name='留言类型')),
