...
class Goods(models.Model):
    ...
    click_num = models.ImageField(default=0, verbose_name="点击数")
    ...
    goods_desc = UEditorField(default='',imagePath="goods/images/", filePath="goods/files/", width=1000, height=300,  verbose_name=u"内容")
    ship_free = models.BooleanField(default=True, verbose_name="是否承担运费")
    goods_front_image = models.ImageField(upload_to="goods/images/", null=True, blank=True, verbose_name="商品封面图")
